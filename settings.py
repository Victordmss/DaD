...
EDITOR_DATA = {
    ...
    3: {'style': 'tree', 'type': 'object', 'menu': 'tree',
        'menu_surf': 'resources/assets/decorations/nature/tree1/tree1.png',
        'preview': 'resources/assets/decorations/nature/tree1/tree1.png',
        'graphics': 'resources/assets/decorations/nature/tree1'},
    4: {'style': 'tree', 'type': 'object', 'menu': 'tree',
        'menu_surf': 'resources/assets/decorations/nature/tree2/tree2.png',
        'preview': 'resources/assets/decorations/nature/tree2/tree2.png',
        'graphics': 'resources/assets/decorations/nature/tree2'},
    5: {'style': 'tree', 'type': 'object', 'menu': 'tree',
        'menu_surf': 'resources/assets/decorations/nature/tree3/tree3.png',
        'preview': 'resources/assets/decorations/nature/tree3/tree3.png',
        'graphics': 'resources/assets/decorations/nature/tree3'},
    ...
    9: {'style': 'sign', 'type': 'object', 'menu': 'sign',
        'menu_surf': 'resources/assets/decorations/sign1/sign1.png',
        'preview': 'resources/assets/decorations/sign1/sign1.png',
        'graphics': 'resources/assets/decorations/sign1'},
    10: {'style': 'sign', 'type': 'object', 'menu': 'sign',
         'menu_surf': 'resources/assets/decorations/sign2/sign2.png',
         'preview': 'resources/assets/decorations/sign2/sign2.png',
         'graphics': 'resources/assets/decorations/sign2'},
